local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/noob-scripts/some-scripts/refs/heads/master/Wild%20Hub/Small-Scripts/Small-OrionLib.lua')))()
local default = {
