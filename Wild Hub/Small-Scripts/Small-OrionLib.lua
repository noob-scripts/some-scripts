-- the modifications i did in this script is trash
...
function OrionLib:MakeNotification(NotificationConfig)
	spawn(function()
		...
		NotificationConfig.Image = NotificationConfig.Image or Icons.bell
...
function OrionLib:MakeWindow(WindowConfig)
  ...
  local par = CloseBtn.Parent
  par.Position = UDim2.new(par.Position.X.Scale, -40, par.Position.Y.Scale, par.Position.Y.Offset)
  par.Size = UDim2.new(0.15, 0, 0.6, 0)
  ...
  par.Frame:Destroy()
	...
	function TabFunction:MakeTab(TabConfig)
		...
		local Container = AddThemeObject(SetChildren(SetProps(MakeElement("ScrollFrame", Color3.fromRGB(255, 255, 255), 5), {
			Size = UDim2.new(1, 0, 1, -50), -- {0, 0}, {0, 50}
			Position = UDim2.new(0, 0, 0, 50), -- {1, 0}, {1, -50}
			Parent = MainWindow,
			Visible = false,
			Name = "ItemContainer"
		}), {
